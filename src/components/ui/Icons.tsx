...
const ICONS: Record<string, string> = {
  ...
  flower: '<circle cx="12" cy="12" r="3"/><path d="M12 15v7"/><path d="M12 2a3 3 0 0 1 3 3 3 3 0 0 1-3 3 3 3 0 0 1-3-3 3 3 0 0 1 3-3Z"/><path d="M15 12a3 3 0 0 1 3-3 3 3 0 0 1 3 3 3 3 0 0 1-3 3 3 3 0 0 1-3-3Z"/><path d="M12 15a3 3 0 0 1-3 3 3 3 0 0 1-3-3 3 3 0 0 1 3-3 3 3 0 0 1 3 3Z"/><path d="M9 12a3 3 0 0 1-3 3 3 3 0 0 1-3-3 3 3 0 0 1 3-3 3 3 0 0 1 3 3Z"/>',
  ...
  video: '<path d="m16 13 5.22-3.13a1 1 0 0 1 1.5.87v6.5a1 1 0 0 1-1.5.87L16 15"/><rect x="2" y="7" width="14" height="10" rx="2"/>',
...
export function Ico({ name, size = 18, color = 'currentColor', sw = 2, style }: IcoProps) {
  return (
